...
if( !function_exists( 'anp_kbe_template_path_override' ) ) {
  ...
  function anp_kbe_template_path_override() {
    return get_template_directory() . '/plugins/kbe/';
  }
...
/**
 * Unregister WP-Knowledge Base Sidebar
 * Register new WP-Knowledge Base Sidebar
 */
if( !function_exists( 'anp_kbe_replace_sidebar' ) ) {
  
  function anp_kbe_replace_sidebar(){
      unregister_sidebar( 'kbe_cat_widget' );
      register_sidebar( array(
        'name'          => esc_html__( 'Knowledge Base', 'anp-network-main' ),
        'id'            => 'kbe_knowledgebase',
        'description'   => '',
  ...
  add_action ('widgets_init', 'anp_kbe_replace_sidebar', 11);
}


if( !function_exists( 'anp_kbe_template' ) ) {
