			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_activity_can_favorite() ) : ?>
					...
					<?php if ( !bp_get_activity_is_favorite() ) : ?>
						...
						<a href="<?php bp_activity_favorite_link(); ?>" class="button fav bp-secondary-action" title="<?php esc_attr_e( 'Like', 'buddypress' ); ?>"><?php _e( 'Like', 'buddypress' ); ?></a>

					<?php else : ?>

						<a href="<?php bp_activity_unfavorite_link(); ?>" class="button unfav bp-secondary-action" title="<?php esc_attr_e( 'Unlike', 'buddypress' ); ?>"><?php _e( 'Unlike', 'buddypress' ); ?></a>
